...
// Маршрутизация для главной страницы используя контроллер и экшн 'HomeController@index'
Route::get ('/', 'App\Http\Controllers\HomeController@index')->name ('home'); // Дадим имена нашим шаблонам, чтобы в дальнейшем мы могли прописать корректно ссылки используя функцию Root в шаблоне
